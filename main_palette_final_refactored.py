...
#            print(f"Processing cell: slot_id={slot_id}, type={cell_type}")
            ...
            if cell_type == "grid" and slot_id.startswith("Button_"):
                ...
                icon_path = os.path.join("resources", "moon.png")  # Fallback just for init                print(f"[DEBUG] Theme_Toggle searching at: {icon_path}")
...
if __name__ == "__main__":
    ...
    window = WENPalette(os.path.join("WEN_palette_runtime_layout_default.json"))
